...
class BSTree                                     // KeyType : key field
{
  ...
  protected:
    ...
    void writeKeyHelper(BSTreeNode *p) const;	
    void copyHelper(BSTreeNode *source, BSTreeNode *& main);
    void countHelper(BSTreeNode *p, int &counter) const;
    void writeLessThanHelper(BSTreeNode *p, const KeyType& searchKey) const;
    int heightHelper(BSTreeNode *node) const;
    void removeHelperHelper(BSTreeNode *& ptr, BSTreeNode *&p);
